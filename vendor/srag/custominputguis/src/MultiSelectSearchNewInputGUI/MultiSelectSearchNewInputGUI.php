...
namespace srag\CustomInputGUIs\Certificate\MultiSelectSearchNewInputGUI;

use ilFormPropertyGUI;
use ilTableFilterItem;
use ilTemplate;
use ilToolbarItem;
use srag\CustomInputGUIs\Certificate\Template\Template;
use srag\DIC\Certificate\DICTrait;

/**
 * Class MultiSelectSearchNewInputGUI
 *
 * @package srag\CustomInputGUIs\Certificate\MultiSelectSearchNewInputGUI
 *
