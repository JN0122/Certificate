...
class srCertificateDefinitionGUI
{
    ...
    protected function setSubTabs()
    {
        if ($this->definition !== null) {
            $this->tabs->addSubTab(self::TAB_SHOW_CERTIFICATES, $this->pl->txt('show_certificates'),
                $this->ctrl->getLinkTarget($this, self::CMD_SHOW_CERTIFICATES));
            $this->tabs->addSubTab(self::TAB_SHOW_PARTICIPANTS, $this->pl->txt('participants'),
                $this->ctrl->getLinkTarget($this, self::CMD_SHOW_PARTICIPANTS));
        }
        $this->tabs->addSubTab(self::TAB_SHOW_DEFINITION, $this->pl->txt('definition_settings'),
            $this->ctrl->getLinkTarget($this, self::CMD_SHOW_DEFINITION));
        if ($this->definition !== null) {
            $this->tabs->addSubTab(self::TAB_SHOW_PLACEHOLDERS, $this->pl->txt('placeholders'),
                $this->ctrl->getLinkTarget($this, self::CMD_SHOW_PLACEHOLDERS));
            $this->tabs->addSubTab(self::TAB_PARTICIPATION_CERTIFICATE, $this->pl->txt('participation_certificate'),
                $this->ctrl->getLinkTarget($this, self::CMD_SHOW_PARTICIPATION_CERTIFICATE));
        }
    }
